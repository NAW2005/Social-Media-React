    ...
    <div className="w-[40%] min-h-screen grid-rows-4 mx-auto grid">
      ...
      <div className="row-span-3">
        <div className="relative">
          <img
            src={profileImg}
            className="absolute w-[160px] top-[-100px] left-[20px] border-4 border-white rounded-full"
            alt=""
          />
        </div>
        <div className="mt-[80px]">
          <div>
            <h1 className="my-3 font-semibold mx-3 text-xl">Sin War Naw</h1>
            <div className="mb-[15px] flex justify-between items-center mx-4">
              <button className=" mx-2 flex justify-center items-center w-full py-2 text-white rounded-md bg-indigo-500">
                <AiFillPlusCircle className="mx-3 text-xl" />
                Add to Story
              </button>
              <button className="mx-2 flex justify-center items-center w-full py-2 text-gray-800 rounded-md bg-gray-300">
                <AiFillEdit className="mx-3 text-xl" />
                Edit profile
              </button>
              <button className="bg-gray-300 px-3 py-3 rounded-md">
                <BsThreeDots />
              </button>
            </div>
          ...
          <div className="mx-1 mt-[15px]">
            <div className="flex my-1 py-1 mx-2 justify-start items-center">
              <AiFillClockCircle className="text-xl mx-3 text-gray-500" />
              <p>Joined on September 2020</p>
            </div>
            <div className="flex my-1 py-1 mx-2 justify-start items-center">
              <AiFillGithub className="text-xl mx-3 text-gray-500" />
              <p>NAW2005</p>
            </div>
            <div className="flex my-1 py-1 mx-2 justify-start items-center">
              <BsThreeDots className="text-xl mx-3 text-gray-500" />
              <p>See your About info</p>
            </div>
          </div>
          <div className="my-4">
            <div className="flex overflow-x-scroll scroll-none-cus mx-4 h-[215px] ">
              <div className="bg-indigo-300 rounded-xl flex justify-center items-center h-full text-gray-500 text-[30px] mx-2">
                <AiOutlinePlus className="w-[130px]" />
              </div>
          ...
          <div className="w-[100%] flex justify-center items-center mx-auto">
            <button className="bg-indigo-200 text-indigo-500 rounded-md my-2 w-[70%] font-semibold py-2">
              Edit Public Details
            </button>
          </div>
        </div>
        ...
        <div className="mt-[5px]">
                ...
                {friendList.map((friend, index) => {
                  return (
                    <div>
                      <img
                        src={friend.img}
                        className="h-[170px] m-2 rounded-xl"
                        alt=""
                      />
          ...
          <div className="flex justify-center items-center mt-5 w-[90%] mx-auto">
            <button className="bg-gray-300 w-[600px] mx-auto py-2 rounded-md font-semibold text-gray-600">
              See All Friends
            </button>
          </div>
        </div>
